...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
	<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="{base}/" style="background: #212529;">DL on the web</a>
	...
	<div class="ms-auto me-3 d-flex align-items-center">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-moon" viewBox="0 0 16 16">
        <path d="M6 .278a.77.77 0 0 1 .08.858 7.2 7.2 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277q.792-.001 1.533-.16a.79.79 0 0 1 .81.316.73.73 0 0 1-.031.893A8.35 8.35 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.75.75 0 0 1 6 .278M4.858 1.311A7.27 7.27 0 0 0 1.025 7.71c0 4.02 3.279 7.276 7.319 7.276a7.32 7.32 0 0 0 5.205-2.162q-.506.063-1.029.063c-4.61 0-8.343-3.714-8.343-8.29 0-1.167.242-2.278.681-3.286"/>
			...
			{#if topic!="" }
			<button aria-label="Show documentation page" class="btn btn-sm" type="button"  onclick={() => showInfoRow = !showInfoRow}>
...
<div class="container-fluid">
	...
	<!-- Sidebar (static left) -->
<div class="sidebar d-none d-md-block col-md-3 col-lg-2 p-0 bg-body-tertiary vh-100 position-fixed">
	<div
...
>
	...
	<ul class="nav flex-column mb-auto">
		...
		<ul class="nav flex-column mb-auto">
			{#each models as mdl }
			<li class="nav-item">
				<a class="nav-link d-flex align-items-center gap-2" href={base+"/inference/"+mdl.value}>
...
<div class="offset-md-3 offset-lg-2 col-md-9 col-lg-10 d-flex p-0">
  ...
  <!-- Conditional Info Panel -->
	{#if showInfoRow}
  <div class="col-4 px-3 pt-4 border-start vh-100 position-fixed end-0 top-2" style="z-index: 1030;">
    <div class="info-panel">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="m-0 text-secondary">Help</h5>
        <button class="btn btn-sm btn-close" aria-label="Close" onclick={() => showInfoRow = false}></button>
      </div>
      <Documentation {topic}/>
